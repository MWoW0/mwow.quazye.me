...
class ApplyCharacterServices implements ShouldQueue
{
    ...
    public function handle()
    {
        $this
            ...
            ->products()
            ->services()
            ->each(function ($serviceProduct) {
                switch ($serviceProduct->type) {
                    case 'boost':
                        $this->emulator->boostCharacter($this->characterId, $serviceProduct->reference);
                        break;
                }
            });
    }
